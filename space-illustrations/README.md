...
| `out*/` ×4 | 四套成品：`<slug>.svg`（源）；mono/seven/v1 另有 `png/<slug>.png`（2x · 嵌入用），vivid 仅 SVG |
...
- **无文字** · **黑块统一**（mono/seven/vivid 无大墨块；v1 保留原样）· **裁切安全**（主体在中心 480×480，抗 3:4 与 4:3 中心裁，画廊有校验线开关）· 超长超扁版留 `--wide` 占位待做。
