...
| 子目录 | 内容 | 状态 |
|---|---|---|
| `space-illustrations/` | 7 个 space group 矢量插图 · 四套统一命名（✅ mono 正式 / seven 备份 / vivid 对照 / v1 旧版）+ 生成器 + 切换画廊 + 嵌入链接清单 | ✅ 定稿 2026-07-15 |
...
例（市政厅插图 · 正式版 mono）：
```
https://raw.githubusercontent.com/MtsYama/superlinear-visuals/main/space-illustrations/out-mono/png/townhall.png
```
四套（✅ mono 正式 / seven 备份 / vivid 对照 / v1 旧版）完整清单见 `space-illustrations/EMBED-LINKS.md`。
